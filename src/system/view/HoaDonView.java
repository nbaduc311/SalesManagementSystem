...
public class HoaDonView extends JPanel {
     ...
     */
    public void updateProductQuantityInCart(int rowIndex, int newQuantity, SanPham sanPham) { // Đã thêm SanPham sanPham
     ...
     * @return Tổng số tiền.
     */
    public int getCurrentTotalAmount() { // Đã đổi kiểu trả về sang int
